...
\begin{figure}[htbp]
    ...
    (b) is Scatter plot comparing the estimated log countings against the ground truth for each solver on 
    the BIRD benchmark}
    \label{fig:total}
\end{figure}
...
To prove that the three attention mechanisms of our AEIN model are effective, Table~\ref{tab2} shows its 
